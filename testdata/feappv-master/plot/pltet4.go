...
func PLTET4(IEL *int) {
	...
	if (*(IEL)) > 0 {
		...
		IPORD(func() *int { y := 4; return &y }(), (IEL)) = 1
		IPORD(func() *int { y := 5; return &y }(), (IEL)) = 4
		IPORD(func() *int { y := 6; return &y }(), (IEL)) = 2
		IPORD(func() *int { y := 7; return &y }(), (IEL)) = 3
		IPORD(func() *int { y := 8; return &y }(), (IEL)) = 4
		...
		EPORD(func() *int { y := 4; return &y }(), -(*(IEL))) = 1
		EPORD(func() *int { y := 5; return &y }(), -(*(IEL))) = 4
		EPORD(func() *int { y := 6; return &y }(), -(*(IEL))) = 2
		EPORD(func() *int { y := 7; return &y }(), -(*(IEL))) = 3
		EPORD(func() *int { y := 8; return &y }(), -(*(IEL))) = 4
