...
//*>
//*  =====================================================================
func DSYMV(UPLO *byte, N *int, ALPHA *float64, A *[][]float64, LDA *int, X *[]float64, INCX *int, BETA *float64, Y *[]float64, INCY *int) {
	...
	if INFO != 0 {
		XERBLA(func()*[]byte{y:=[]byte("DSYMV ");return &y}(), &(INFO))
		return
	}
	//*
