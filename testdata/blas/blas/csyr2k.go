...
//*>
//*  =====================================================================
func CSYR2K(UPLO *byte, TRANS *byte, N *int, K *int, ALPHA *complex64, A *[][]complex64, LDA *int, B *[][]complex64, LDB *int, BETA *complex64, C *[][]complex64, LDC *int) {
	var TEMP1 complex64
	var TEMP2 complex64
	var I int
	var INFO int
	...
	if INFO != 0 {
		XERBLA(func()*[]byte{y:=[]byte("CSYR2K");return &y}(), &(INFO))
		return
	}
	//*
