...
//*>
//*  =====================================================================
func DSYMM(SIDE *byte, UPLO *byte, M *int, N *int, ALPHA *float64, A *[][]float64, LDA *int, B *[][]float64, LDB *int, BETA *float64, C *[][]float64, LDC *int) {
	var TEMP1 float64
	var TEMP2 float64
	var I int
	var INFO int
	...
	if INFO != 0 {
		XERBLA(func()*[]byte{y:=[]byte("DSYMM ");return &y}(), &(INFO))
		return
	}
	//*
