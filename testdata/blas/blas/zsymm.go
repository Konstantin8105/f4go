...
//*>
//*  =====================================================================
func ZSYMM(SIDE *byte, UPLO *byte, M *int, N *int, ALPHA *complex128, A *[][]complex128, LDA *int, B *[][]complex128, LDB *int, BETA *complex128, C *[][]complex128, LDC *int) {
	...
	if INFO != 0 {
		XERBLA(func()*[]byte{y:=[]byte("ZSYMM ");return &y}(), &(INFO))
		return
	}
	//*
