...
//*>
//*  =====================================================================
func DTRMM(SIDE *byte, UPLO *byte, TRANSA *byte, DIAG *byte, M *int, N *int, ALPHA *float64, A *[][]float64, LDA *int, B *[][]float64, LDB *int) {
	var TEMP float64
	var I int
	var INFO int
	var J int
	...
	if INFO != 0 {
		XERBLA(func() *[]byte { y := []byte("DTRMM "); return &y }(), &(INFO))
		return
	}
	//*
