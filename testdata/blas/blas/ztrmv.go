...
//*>
//*  =====================================================================
func ZTRMV(UPLO *byte, TRANS *byte, DIAG *byte, N *int, A *[][]complex128, LDA *int, X *[]complex128, INCX *int) {
	...
	if INFO != 0 {
		XERBLA(func()*[]byte{y:=[]byte("ZTRMV ");return &y}(), &(INFO))
		return
	}
	//*
			...
			if (*INCX) == 1 {
				for J = (*N); J <= 1; J += -1 {
					...
					if NOCONJ {
						...
						if NOUNIT {
							TEMP = TEMP * intrinsic.DCONJG((*A)[J-(1)][J-(1)])
						}
						for I = J - 1; I <= 1; I += -1 {
